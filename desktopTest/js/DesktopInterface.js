    ...
    [
      ...
      e(
        "div",
        {
          key: "tooltip",
          className:
            "absolute bottom-full mb-2 px-2 py-1 bg-black bg-opacity-75 text-white text-xs rounded hidden group-hover:block whitespace-nowrap",
        },
...
const DesktopInterface = () => {
  // Clear story flags on page load/refresh
  React.useEffect(() => {
    localStorage.removeItem("megacorp_recording_played");
    localStorage.removeItem("megacorp_notification_shown");
  ...
  // Check for MegaCorp message trigger
  React.useEffect(() => {
    const checkInterval = setInterval(() => {
      const recordingPlayed =
        localStorage.getItem("megacorp_recording_played") === "true";
      const notificationShown =
        localStorage.getItem("megacorp_notification_shown") === "true";

      if (recordingPlayed && !notificationShown) {
        // Show notification
        setNotification({
          app: "Messages",
          sender: "MegaCorp Security",
          message: "Hello, Subject #47. This is an automated notification...",
          icon: MessageIcon,
        });

        // Mark notification as shown
        localStorage.setItem("megacorp_notification_shown", "true");
    ...
    [
          ...
          e(
            ...
            [
              ...
              e(
                ...
                {
                  className:
                    "mt-1 text-xs text-center text-white group-hover:text-gray-200 bg-black bg-opacity-40 px-2 py-1 rounded",
                },
                "Messages",
              ),
            ],
      ...
      notification &&
        e(
          ...
          e(
            ...
            {
              className:
                "bg-white rounded-lg shadow-2xl border border-gray-300 overflow-hidden w-80",
              onClick: () => {
                // Close notification and open Messages app
                setNotification(null);
                messageHelpers.open();
                bringToFront("message");
              },
            ...
            [
              ...
              e(
                "div",
                {
                  key: "header",
                  className:
                    "bg-blue-500 px-4 py-2 flex items-center space-x-2",
                },
                [
                  e(
                    "div",
              ...
              e(
                "button",
                {
                  key: "close",
                  className:
                    "absolute top-2 right-2 text-white hover:text-gray-200 w-6 h-6 flex items-center justify-center",
                  onClick: (e) => {
                    e.stopPropagation();
                    setNotification(null);
                  },
      ...
      e(
        "div",
        {
          key: "dock",
          className:
            "absolute bottom-0 w-full bg-white bg-opacity-80 backdrop-blur-sm border-t border-gray-200",
          style: { zIndex: 9999 },
        },
        e(
          "div",
          {
            className:
              "relative w-full px-4 py-2 flex items-center justify-center",
          },
          [
