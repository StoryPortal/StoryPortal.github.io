...
Kaiser Center`,
  ...
  },
  {
    ...
    to: "adampell@gmail.com",
    subject: "Welcome to the Product X Partnership Program!",
    body: `Dear Alex Pell,

Congratulations and welcome to the MegaCorp Product X Partnership Program!

We're thrilled to have you as Subject #47 in our groundbreaking beta testing initiative. Your participation will help shape the future of neural interface technology.

PROGRAM DETAILS:
- Duration: 12 weeks (4 testing phases)
- Compensation: $2,400 upon successful completion
- Your Subject ID: #47

GETTING STARTED:

We've set up a secure portal account for you to access testing documentation, schedules, and support resources. Your portal credentials have been configured on your local system.

Portal Access Instructions:
1. Open your Terminal application
2. Navigate to: ~/documents/ProductXInfo/
3. Run the portal connection script: ./portal_connect.sh
4. Login with your credentials:
   - Username: subject47
   - Password: productx2024

Your portal contains:
- Testing agreement and program guidelines
- Safety documentation
- FAQ and support resources
- Weekly testing schedules

IMPORTANT REMINDERS:
- Weekly health check-ins are mandatory
- Report any side effects promptly via your portal
- All information is confidential and proprietary

If you have any questions or concerns, please don't hesitate to reach out to your testing coordinator.

We're excited to have you on this journey with us!

Best regards,
Dr. Sanguis
Lead Researcher, Product X Division
MegaCorp Advanced Technologies
testing@megacorp.com

---
CONFIDENTIAL: This email contains proprietary information. Do not forward or share.

[ATTACHMENT: portal_access_guide.pdf - See Terminal for portal connection tool]`,
    date: "2023-12-15",
    folder: "inbox",
    isRead: true,
  },
  {
    id: 7,
    from: "support@megacorp.com",
    to: "adampell@gmail.com",
    subject: "RE: Portal Login Issue - RESOLVED",
    body: `Hello Alex,

Your portal access has been restored. You should now be able to log in with your original credentials (subject47 / productx2024).

Please let us know if you experience any further issues.

Best regards,
MegaCorp Technical Support

------- Internal Discussion (DO NOT FORWARD) -------
From: IT-Admin <itadmin@megacorp.internal>
To: Support Team <support@megacorp.com>
Date: Jan 2, 2024 3:42 PM

Reset subject47 portal access. Standard subject credentials restored.

NOTE: Do NOT confuse with employee portal access (s4ngu1s).
Subject portals and employee monitoring portals are separate systems.
Subjects should NEVER have employee credentials.

- Mark
IT Security Administrator

------- Original Message -------
From: Alex Pell <adampell@gmail.com>
To: support@megacorp.com
Date: Jan 2, 2024 2:15 PM

Hi, I'm having trouble logging into the Product X portal. My username is subject47 but the password isn't working. Can you help?
...
const LookoutContent = ({ isMaximized, windowSize }) => {
  ...
  const toggleReadStatus = (email, e) => {
    ...
    setEmails(
      emails.map((e) => (e.id === email.id ? { ...e, isRead: !e.isRead } : e)),
    );
  };
  ...
  const deleteEmail = (email) => {
    setEmails(
      emails.map((e) => (e.id === email.id ? { ...e, folder: "trash" } : e)),
    );
          ...
          [
            e(
              "button",
              {
                ...
                onClick: sendEmail,
                className:
                  "px-3 py-1 bg-blue-500 text-white rounded-lg hover:bg-blue-600 mr-2",
              },
              "Send",
            ),
            e(
              "button",
              {
                ...
                onClick: saveDraft,
                className:
                  "px-3 py-1 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 mr-2",
              },
              "Save Draft",
            ),
            e(
              "button",
              {
                ...
                className:
                  "px-3 py-1 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300",
              },
              "Discard",
            ),
          ],
            ...
            e(
              ...
              [
                ...
                e("input", {
                  ...
                  className:
                    "flex-1 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-blue-500",
                }),
              ],
            ),
            e(
          ...
          [
            ...
            e(
              "button",
              {
                key: "new-email",
                className:
                  "w-full py-2 px-3 mb-3 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors",
                      ...
                      folder.unread &&
                        ...
                        e(
                          "span",
                          {
                            key: "unread-count",
                            className:
                              "bg-blue-600 text-white text-xs font-bold rounded-full px-2 py-1 mr-1",
                          },
                          folder.unread,
                        ),
                  ...
                  e(
                    ...
                    filteredEmails.length > 0
                                  ...
                                  [
                                    ...
                                    e(
                                      ...
                                      !email.isRead
                                        ? e("div", {
                                            className:
                                              "w-3 h-3 rounded-full bg-blue-500 cursor-pointer hover:bg-blue-600",
                                          })
                                        : e("div", {
                                            className:
                                              "w-3 h-3 rounded-full border border-gray-300 cursor-pointer hover:border-blue-500",
                                          }),
                                    ),
                      ...
                      : e(
                          ...
                          {
                            className:
                              "flex items-center justify-center h-full text-gray-500 p-4",
                          },
                      ...
                      ? [
                          ...
                          e(
                            "div",
                            {
                              key: "actions",
                              className:
                                "mt-4 pt-3 border-t border-gray-200 flex space-x-2",
                            },
                            [
                              folderView === "inbox" &&
                                e(
                                  "button",
                                  {
                                    key: "reply",
                                    className:
                                      "px-3 py-1 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200",
                                    onClick: () => {
                              ...
                              folderView === "inbox" &&
                                e(
                                  "button",
                                  {
                                    key: "forward",
                                    className:
                                      "px-3 py-1 bg-gray-100 text-gray-700 rounded-lg hover:bg-gray-200",
                                    onClick: () => {
                              ...
                              e(
                                "button",
                                {
                                  key: "delete",
                                  className:
                                    "px-3 py-1 bg-red-100 text-red-700 rounded-lg hover:bg-red-200",
